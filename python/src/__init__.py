...
from .autolabel import (
    autolabel, 
    get_variable_label, get_variable_labels, set_variable_label, set_variable_labels,
    get_value_label, get_value_labels, set_value_labels, set_value_labels_dict,
...
pd.DataFrame.get_variable_label = get_variable_label
pd.DataFrame.get_variable_labels = get_variable_labels
pd.DataFrame.set_variable_label = set_variable_label
pd.DataFrame.set_variable_labels = set_variable_labels
pd.DataFrame.get_value_label = get_value_label
pd.DataFrame.get_value_labels = get_value_labels
pd.DataFrame.set_value_labels = set_value_labels
pd.DataFrame.set_value_labels_dict = set_value_labels_dict
